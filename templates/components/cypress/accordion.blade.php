...
@php
  ...
  $activeAccordionClasses = $data['activeAccordionClasses'] ?? 'bg-white dark:bg-midnight-950 bg-opacity-50 dark:bg-opacity-10 rounded-xl p-3';
  $iconContainerClasses = $data['iconContainerClasses'] ?? 'h-10 w-10 flex items-center justify-center mr-2';
  $activeIconContainerClasses = $data['activeIconContainerClasses'] ?? 'bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-full';
  $inactiveIconContainerClasses = $data['inactiveIconContainerClasses'] ?? 'bg-white dark:bg-midnight-950';
  $iconClasses = $data['iconClasses'] ?? 'inline-block h-4 w-4';
  $activeIconClasses = $data['activeIconClasses'] ?? 'text-white';
  $inactiveIconClasses = $data['inactiveIconClasses'] ?? 'text-gray-700 dark:text-gray-300';
  $titleClasses = $data['titleClasses'] ?? 'font-bold';
  $contentClasses = $data['contentClasses'] ?? 'text-gray-400 dark:text-gray-500';
